...
class ConfigManager:
    ...
    CONFIG_LABELS = MappingProxyType(
        {
            ...
            "OFFLINE_TILES_ENABLED": "Serve Maps From Local Tile Store (offline)",
            "OFFLINE_TILES_DIR": "Offline Tile Store Directory",
            "OFFLINE_TILES_SOURCE": "Offline Tile Upstream Source URL",
            "OFFLINE_TILES_MAX_ZOOM": "Offline Tile Maximum Zoom",
    ...
    def serialize():
        ...
        conf = {
            ...
            "OFFLINE_TILES_ENABLED": cfg.OFFLINE_TILES_ENABLED,
            "OFFLINE_TILES_DIR": cfg.OFFLINE_TILES_DIR,
            "OFFLINE_TILES_SOURCE": cfg.OFFLINE_TILES_SOURCE,
            "OFFLINE_TILES_MAX_ZOOM": cfg.OFFLINE_TILES_MAX_ZOOM,
