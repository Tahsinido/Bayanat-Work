...
class FieldDataSiteValidationModel(StrictValidationModel):
    ...
    collected_data_by: Optional[str] = DEFAULT_STRING_FIELD
    data_types: Optional[List[str]] = None
    type_of_site: Optional[str] = DEFAULT_STRING_FIELD
    no_of_site: Optional[int] = Field(default=None, ge=0)
    code: Optional[str] = DEFAULT_STRING_FIELD
    total_photos: Optional[int] = Field(default=None, ge=0)
    total_videos: Optional[int] = Field(default=None, ge=0)
    total_interviews: Optional[int] = Field(default=None, ge=0)
    translation: Optional[str] = DEFAULT_STRING_FIELD
    drone_photos: Optional[int] = Field(default=None, ge=0)
    drone_videos: Optional[int] = Field(default=None, ge=0)
    data_size_for_site: Optional[str] = DEFAULT_STRING_FIELD
    total_size: Optional[str] = DEFAULT_STRING_FIELD
    data_storage_location: Optional[str] = DEFAULT_STRING_FIELD
    external_link: Optional[str] = Field(default=None, max_length=2048)
    description: Optional[str] = None
    legal_analysis: Optional[str] = None
    analysis_by: Optional[str] = DEFAULT_STRING_FIELD
    analysis_date: Optional[str] = None
    shared_with: Optional[str] = DEFAULT_STRING_FIELD
    excavated_status: Optional[str] = DEFAULT_STRING_FIELD
    ...
    @classmethod
    def validate_site_dates(cls, value: Optional[str]) -> Optional[str]:
        if value in (None, ""):
            return None
        try:
            parse(value)
...
class FieldDataValidationModel(StrictValidationModel):
    name_of_site: str = Field(min_length=1, max_length=255)
    mission_date: Optional[str] = None
    collected_data_by: Optional[str] = DEFAULT_STRING_FIELD
    data_types: Optional[List[str]] = None
    type_of_site: Optional[str] = DEFAULT_STRING_FIELD
    ...
    has_interview: Optional[bool] = False
    interview_names: Optional[List[str]] = None
    # PartialMediaModel, not MediaValidationModel: the latter is an empty
    # subclass defined further down this module and is not yet bound here.
    medias: Optional[List[PartialMediaModel]] = None
    # Echoed back by the front-end on PUT; ignored by from_json.
    id: Optional[int] = None
    updated_at: Optional[str] = None
...
class FieldDataRequestModel(BaseValidationModel):
    item: FieldDataValidationModel
