...
const routes = [
    ...
    {path: '/admin/evidence/', name: 'evidence', component: Vue.defineComponent({})},
    {path: '/admin/evidence/:id', name: 'evidence-item', component: Vue.defineComponent({})},
    {path: '/admin/download-requests/', name: 'download-requests', component: Vue.defineComponent({})},
